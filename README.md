...
How we built it
Our team used HTML and CSS to design the popup app. We deployed a Google Cloud Function in Node.js that uses the Google Cloud Natural Language API to determine the most important entities, then searching on our Google Topical Engine for related places for donation.
